        ...
        <main>
            ...
            <section>
                <div class="ak-hero ak-style1">
                    <div class="ak-hero-bg ak-bg" data-src="{{ asset('assets/img/clan-hero-carta-detalle.jpg') }}"></div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="slider-info">
                                        ...
                                        <div>
                                            <p class="hero-sub-text">Welcome to our restaurant, where culinary artistry
            ...
            <div class="ak-moving-section-wrap ak-normal text-uppercase">
                <div class="ak-moving-section-in">
                    <div class="ak-moving-section">
                        <h2><span>Embark</span> on a gastronomic <span>adventure</span>, guided by <span>our
                                exquisite</span> dishes</h2>
                    </div>
                    <div class="ak-moving-section">
                        <h2><span>Embark</span> on a gastronomic <span>adventure</span>, guided by <span>our
                                exquisite</span> dishes</h2>
                    ...
                    <div class="container">
                        <div class="about-section ak-about-1">
                            <div class="about-text-section">
                                ...
                                <div class="ak-height-30 ak-height-lg-30"></div>
                                <p class="about-subtext">Lorem to our restaurant, where culinary artistry meets
                                    exceptional dining experiences. At, we strive to create a gastronomic haven that.
                                </p>
            ...
            <section>
                ...
                <div class="container-fluid">
                    <div class="ak-section-heading ak-style-1 ak-type-1">
                        <div class="ak-section-subtitle">Food Items</div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="booking-system-heading">
                                    <div class="ak-section-heading ak-style-1">
                                        ...
                                        <h2 class="ak-section-title anim-title-2">Reservations
                                        </h2>
                                    </div>
