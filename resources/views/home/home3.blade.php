...
<body>
    ...
    <header class="ak-site_header ak-style1 ak-sticky_header ak-site_header_full_width d-xl-none">
    ...
    <div id="scrollsmoother-container">
        <div class="row m-0 sidebar-hero-3" id="containerAround">
            <div class="col-xl-2 sidebar-hero-3-bg col-0 p-0 d-none d-xl-block m-0">
                <div id="infoProduto">
                    <div class="sidebar-contain">
                        ...
                        <div class="section-link">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('menu') }}">Food Menu</a>
                                </li>

                                <li>
                                    <a href="{{ route('chef') }}">Our Chef</a>
                                </li>
                                <li>
                        ...
                        <div>
                            <div class="text-btn text-uppercase">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="slider-info">
                                                <div class="hero-title">
                                                    <p class="mini-title">Elegant Italian Food</p>
                    ...
                    <section>
                        ...
                        <div class="container">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <img src="{{ asset('assets/img/food-menu.png') }}" alt="...">
                                </div>
                            </div>
                    ...
                    <section class="container">
                        ...
                        <div class="opening-hour type-2">
                            <div class="opening-hour-img-section style-2">
                                <img src="{{ asset('assets/img/about_open_hour_2.jpg') }}" class="imagesZoom opening-bg-img ak-bg" alt="...">
                                <div class="overlap-opening-img"></div>
                            </div>
                            <div class="opening-hour-text-section type-2">
                                <h2 class="opening-hour-title  anim-title-2"><span class="ak-white-color">Exquisite
                                        Dining Experience Fit for</span>Royalty
                                </h2>
                                <div class="ak-height-30 ak-height-lg-30"></div>
                                <p class="opening-hour-subtext">Welcome to our restaurant, where culinary artistry meets
                                ...
                                <div class="ak-height-30 ak-height-lg-30"></div>
                                <div class="opening-hour-subtext">
                                    <p>Lorem to our restaurant, where culinary artistry meets exceptional dining
                                        experiences. At, we strive to create a gastronomic haven that.</p>
                                </div>
                                <div class="ak-height-40 ak-height-lg-30"></div>
                                <div class="text-btn">
                                    <a href="{{ route('reservations') }}" class="text-btn1">
                                        ...
                                        <div class="testimonial-section">
                                            ...
                                            <div class="testimonial-info-section">
                                                <div class="testimonial-info">
                                                    ...
                                                    <p class="testimonial-info-subtitle">“Their talented team of
                                                        passionate chefs masterfully crafts each dish, combining the
                                                        finest ingredients with innovative techniques to present
                                                        culinary creations that are as visually stunning as they
                                                        are delicious.”</p>
                                                </div>
                                            </div>
                                            <div class="testimonial-icon-1">
