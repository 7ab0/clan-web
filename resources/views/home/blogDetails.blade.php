...
<section class="container">
    ...
    <div class="blog-details">
        <h3 class="anim-title-3">Indulge in Exquisite Dining</h3>
    ...
    <div class="row" id="containerAround">
        <div class="col-md-8">
            <div class="blog-content" id="scrollGaleria">
                    ...
                    <div class="testimonial-section">
                        ...
                        <div class="testimonial-info-section">
                            <div class="testimonial-info">
                                <p class="testimonial-info-subtitle">“Their talented team of Lorem Ipsum is
                ...
                <div class="ak-height-75 ak-height-lg-30"></div>
                <h4 class="anim-title-2 ak-white-color">Indulge in Exquisite Dining</h4>
                        ...
                        <li class="comment">
                            <div class="comment-body">
                                <div class="comment-author vcard">
                                    <img class="avatar" src="{{ asset('assets/img/author.png') }}" alt="Author">
                            ...
                            <ol class="children">
                                <li class="comment">
                                    <div class="comment-body">
                                        <div class="comment-author vcard">
                                            <img class="avatar" src="{{ asset('assets/img/testimonial_1.jpg') }}" alt="Author">
                    ...
                    <div class="contact-form">
                        ...
                        <from action="jsfdjks.php" method="post">
                            <div class="from-input">
                                <input placeholder="Name" class="col-md-5 col-12" type="text" name="fristname" id="fristname">
                                <input placeholder="Email" class="col-md-5 col-12" type="email" name="email" id="emailid">
                            </div>
                            <div class="col-md-12">
                                <textarea name="textarea" rows="5" class="col-12 col-md-10" placeholder="Comment text."></textarea>
                                </textarea>
                            </div>
        ...
        <div class="col ak-border border-none-bottom drop-anim-gallery">
            <div class="blog h-100">
                ...
                <div class="blog-body">
                    ...
                    <a href="{{ route('blogDetails') }}" class="blog-text">Read More</a>
                </div>
            </div>
        </div>
        <div class="col ak-border border-none-bottom drop-anim-gallery">
